...
final class Flickr extends \alex290\embed\VideoEmbed\Internal\Provider
{

    static function load($url, $result)
    {
        $response = parent::readUrl('http://www.flickr.com/services/oembed?url=' . urlencode($url) . '&format=json');
