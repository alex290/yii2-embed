...
final class Kickstarter extends \alex290\embed\VideoEmbed\Internal\Provider
{

    static function load($url, $result)
    {
        $response = parent::readUrl('http://www.kickstarter.com/services/oembed?url=' . urlencode($url) . '&format=json');
